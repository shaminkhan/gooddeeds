...
router.get('/',middleware.notAllowed, function(req, res, next) {
  res.render('index',{title:"good deeds | Login",header:false,navbar:false});
});
...
router.get('/signup',middleware.notAllowed,function(req,res,next){
	res.render('signup',{title:"good deeds | Sign Up",header:false,navbar:false});
});
                ...
                */
                    ...
                    var mailOptions = {
                        ...
                        html     : `<h1>RESET PASSWORD</h1>
                                    <p>Your request for password reset is approved.Click <a href="/reset/${req.body.email}/${hash}">here</a> to activate.Valid for 30 minutes only.</p>
                                    `
                    };
    ...
    **/
     ...
     var mailOptions = {
            ...
            html     : `<h1>Account Activation</h1>
                        ...
                        a use of it you have to activate your account by clicking <a href="https://temp-mail.org/activate/${userData.username}/${userData.accountToken}">here</a>.</p>
                        `
        };
